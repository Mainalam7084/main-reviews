...
export default async function MovieDetailsPage({
    ...
    return (
        <div className="w-full min-h-screen bg-background">
                ...
                <div className="relative z-20 container mx-auto pt-24 pb-12 md:pt-32 md:pb-16 flex flex-col md:flex-row gap-8 lg:gap-12 items-center md:items-end md:pl-10 lg:pl-18">
                    ...
                    <div className="flex-1 space-y-6 text-center md:text-left">
                        <div className="space-y-3">
                            ...
                            <h1 className="text-3xl md:text-5xl lg:text-6xl font-display font-800 tracking-tighter uppercase text-[#F5F0E8] leading-[0.9]" style={{ textShadow: '3px 3px 0px #E60000' }}>
                                {movie.title}
                            </h1>
                        </div>
            ...
            {/* Content Sections */}
            <main className="container mx-auto py-16 space-y-24 md:pl-10 lg:pl-20">
