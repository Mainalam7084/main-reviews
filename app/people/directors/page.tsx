import { getPopularDirectors } from '@/lib/tmdb';
        ...
        <div className="w-full">
            ...
            <div className="py-12 md:py-16 border-b-3 border-border bg-background px-4 md:px-8">
                <div className="max-w-5xl">
                    <div
                        className="inline-block bg-[#00F5A0] text-[#0A0A0A] px-3 py-1 border-2 border-border font-display font-700 uppercase text-xs tracking-widest mb-4"
                        style={{ boxShadow: '3px 3px 0px 0px var(--border)' }}
                    >
                        Behind the Camera
                    </div>
                    <h1
                        className="text-5xl md:text-7xl font-display font-800 tracking-tighter uppercase text-foreground"
                    ...
                    <p className="mt-4 text-xl font-500 text-muted-foreground max-w-2xl font-sans">
                        The visionaries who shape stories — the most celebrated directors in cinema.
                    </p>
                </div>
            </div>
