...
const CATEGORY_TREE: TreeNode[] = [
    ...
    },
    {
        ...
        accentColor: '#0066FF',
        children: [
            { label: 'Drama', href: '/tv/category/drama' },
            { label: 'Anime', href: '/tv/category/anime' },
            { label: 'Crime', href: '/tv/category/crime' },
            { label: 'Comedy', href: '/tv/category/comedy' },
        ],
    },
    {
        id: 'people',
    ...
    },
    {
        ...
        accentColor: '#FFE500',
        children: [
            { label: 'The Avengers',            href: '/collections/86311' },
            { label: 'Iron Man',                href: '/collections/131292' },
            { label: 'Captain America',         href: '/collections/131295' },
            { label: 'Thor',                    href: '/collections/131296' },
            { label: 'Guardians of the Galaxy', href: '/collections/284433' },
            { label: 'Spider-Man (MCU)',         href: '/collections/531241' },
            { label: 'Amazing Spider-Man',       href: '/collections/125574' },
            { label: 'Spider-Man (Raimi)',       href: '/collections/556' },
            { label: 'Harry Potter',             href: '/collections/1241' },
            { label: 'Fantastic Beasts',         href: '/collections/435259' },
            { label: 'Lord of the Rings',        href: '/collections/119' },
            { label: 'The Hobbit',               href: '/collections/121938' },
            { label: 'James Bond',               href: '/collections/645' },
            { label: 'Fast & Furious',           href: '/collections/9485' },
            { label: 'John Wick',                href: '/collections/404609' },
            { label: 'Jurassic Park',            href: '/collections/328' },
        ],
    },
];
